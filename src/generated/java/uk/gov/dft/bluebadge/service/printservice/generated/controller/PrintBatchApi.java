...
public interface PrintBatchApi {
    ...
    @ApiOperation(value = "Creates a batch of badges to be send for printing", nickname = "printBatchPost", notes = "", tags={ "print batch", })
    @ApiResponses(value = { 
    ...
    default ResponseEntity<Void> printBatch(@ApiParam(value = "Batch badges to be send for printing")  @Valid @RequestBody Batches batch) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
        } else {
            log.warn("ObjectMapper or HttpServletRequest not configured in default PrintBatchApi interface so no example is generated");
        }
