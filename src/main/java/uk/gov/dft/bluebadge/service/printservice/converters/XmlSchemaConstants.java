...
final class XmlSchemaConstants {
  ...
  static class PrintRequestElements {
    ...
    static final String COLLECTION_ADDRESS = "CollectionAddress";
    static final String ADDRESS_NAME1 = "NameLine1";
    static final String ADDRESS_NAME2 = "NameLine2";
    static final String ADDRESS_LINE1 = "AddressLine1";
    static final String ADDRESS_LINE2 = "AddressLine2";
    static final String ADDRESS_LINE3 = "AddressLine3";
    static final String ADDRESS_LINE4 = "AddressLine4";
    static final String ADDRESS_TOWN = "Town";
    static final String ADDRESS_COUNTRY = "Country";
    static final String ADDRESS_COUNTRY_VALUE = "United Kingdom";
    static final String ADDRESS_POSTCODE = "Postcode";
